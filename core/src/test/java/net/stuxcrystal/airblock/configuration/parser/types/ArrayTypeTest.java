...
public class ArrayTypeTest extends TestCase {
    ...
    public void testParse() throws Exception {
        ...
        when(parser.parseNode(String.class, any(DataNode.class))).thenAnswer(new Answer<String>() {
            @Override
    ...
    public void testDump() throws Exception {
        ArrayType type = new ArrayType();
        ConfigurationParser parser = mock(ConfigurationParser.class);
        when(parser.dumpNode(String.class, any(DataNode.class))).thenAnswer(new Answer<DataNode>() {
            @Override
        ...
        when(parser.dumpNode(any(Class.class), any(Object.class))).thenThrow(new IllegalArgumentException());
