...
import moe.encode.airblock.commands.arguments.ArgumentParser;
...
import moe.encode.airblock.commands.contrib.annotations.injections.Argument;
import moe.encode.airblock.commands.contrib.annotations.injections.ScopeObject;
...
public class SimpleAnnotationRegistrarTest {
    ...
    public void testRegistration() {
        ...
        cl.register(tr);
        List<moe.encode.airblock.commands.core.list.Command> commands = cl.getCommands();
        assertEquals(5, commands.size());
        for (moe.encode.airblock.commands.core.list.Command command : commands) {
