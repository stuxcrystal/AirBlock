...
import moe.encode.airblock.commands.contrib.annotations.injections.InjectingMethodCallingStrategy;
...
public @interface Command {
    ...
    public static enum Executor {
        ...
        CONSOLE {
            @Override
            public boolean isSupported(moe.encode.airblock.commands.Executor executor) {
         ...
         * @return If the user
         */
        public abstract boolean isSupported(moe.encode.airblock.commands.Executor executor);
    }
