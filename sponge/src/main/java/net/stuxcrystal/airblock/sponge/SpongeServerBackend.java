...
public class SpongeServerBackend extends BackendHandle<Object, CommandSource> implements Scheduler {
    ...
    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task scheduleTask(Runnable runnable, int delay, int repeat, boolean async) {
        org.spongepowered.api.scheduler.Task.Builder builder = Sponge.getScheduler().createTaskBuilder();
    ...
    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task scheduleTask(Runnable runnable, int delay) {
        return this.scheduleTask(runnable, delay, 0, false);
    }

    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task scheduleTaskAsynchronously(Runnable runnable, int delay) {
        return this.scheduleTask(runnable, delay, 0, true);
    }

    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task scheduleRepetitiveTask(Runnable runnable, int delay, int period) {
        return this.scheduleTask(runnable, delay, period, false);
    }

    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task scheduleRepetitiveAsynchronousTask(Runnable runnable, int delay, int period) {
        return this.scheduleTask(runnable, delay, period, true);
    }

    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task scheduleRepetitiveTask(Runnable runnable, int period) {
        return this.scheduleTask(runnable, 0, period, false);
    }

    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task scheduleRepetitiveAsynchronousTask(Runnable runnable, int period) {
        return this.scheduleTask(runnable, 0, period, true);
    }

    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task runTask(Runnable runnable) {
        return this.scheduleTask(runnable, 0, 0, false);
    }

    public net.stuxcrystal.airblock.commands.contrib.scheduler.Task runTaskAsync(Runnable runnable) {
